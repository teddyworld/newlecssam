				...
				<div id="content">
					...
					<div id="notice-article-detail" class="article-detail margin-large" >						
						...
						<dl class="article-detail-row">
							...
							<dd class="article-detail-data">
							<!--  <img src="uploading-Onepiecekr.jpg" />img-Onepiecekr.jpg<br /> -->
								<a href= "download?f=Onepiecekr.jpg">Onepiecekr.jpg</a>
							</dd>
						</dl>
					...
					<p class="article-comment margin-small">
						...
						<a class="btn-del button" href="noticeDetail?aa=${n.code }">삭제</a>
					</p>
